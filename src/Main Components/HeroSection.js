...
<p className=' text-lg text-white font-semibold'>AI <span className=' text-[#9A9DA3]'>Question Generation Models</span>, Online Compiler and Encrypted Chat groups and bunch of notes <span className=' text-[#9A9DA3]'>For All</span></p>
